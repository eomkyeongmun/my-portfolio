    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 space-y-20">
      ...
      <section>
        <div className="flex flex-wrap items-center gap-2 mb-4">
          ...
          <span className="text-sm text-neutral-400 dark:text-neutral-500">{project.period}</span>
        </div>
      ...
      <section>
        ...
        <div className="space-y-4 text-sm leading-7 text-neutral-700 dark:text-neutral-300">
          ...
          <div className="p-4 rounded-lg bg-neutral-50 dark:bg-neutral-900/60 border border-neutral-200 dark:border-neutral-800">
            <p className="text-xs font-semibold text-neutral-400 dark:text-neutral-500 uppercase tracking-wide mb-2">설계 근거</p>
      ...
      <section>
        ...
        <div className="space-y-4">
          {project.techStack.map((tech) => (
            <div key={tech.name} className="p-4 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/50">
      ...
      <section>
        ...
        <div className="space-y-8">
          {project.problemSolving.map((ps, i) => (
            <div key={i} className="relative pl-6 border-l-2 border-neutral-200 dark:border-neutral-800">
              <div className="absolute -left-[5px] top-1 w-2 h-2 rounded-full bg-neutral-400 dark:bg-neutral-600" />
...
function RetroCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/50">
      <p className="text-xs font-semibold text-neutral-400 dark:text-neutral-500 uppercase tracking-wide mb-2">{label}</p>
